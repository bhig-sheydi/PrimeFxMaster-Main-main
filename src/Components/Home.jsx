...
export const Home = () => {
  ...
  const navigateToLogIn = () => {
    navigate("/login");
    toggleNavbarVisibility(); // Set navbar state to false on login click
  };

  const navigateToSignUp = () => {
    navigate("/signup");
    toggleNavbarVisibility(); // Set navbar state to false on signup click
  };
    ...
    <div className="Home">
      ...
      <div className="Hero4">
        ...
        <div className="Hero4-content">
          ...
          <button className="G"><Link to="/login">GET STARTED</Link></button>
        </div>
      </div>
